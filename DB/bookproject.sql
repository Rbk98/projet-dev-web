...
CREATE TABLE IF NOT EXISTS `choice` (
  ...
  `id_previous_chapter` int(10) NOT NULL,
...
INSERT INTO `cover` (`id_book`, `title`, `summary`, `genre`, `writer`, `date`, `nb_lives`, `nb_chapters_max`, `nb_win`, `nb_reading`, `image`, `status`) VALUES
...
(3, 'Le tombeau des Luciolles', 'Japon, été 1945. Après le bombardement de Kobé, Seita, un adolescent de quatorze ans et sa petite sœur de quatre ans, Setsuko, orphelins, vont s\'installer chez leur tante à quelques dizaines de kilomètres de chez eux. Celle-ci leur fait comprendre qu\'ils sont une gêne pour la famille et doivent mériter leur riz quotidien. Seita décide de partir avec sa petite sœur. Ils se réfugient dans un bunker désaffecté en pleine campagne et vivent des jours heureux illuminés par la présence de milliers de lucioles. Mais bientôt la nourriture commence cruellement à manquer.', 'Drame', 1, '1988-04-16', 3, 3, 2, 38, NULL, 1),
(4, 'Astérix et Cléopatra', 'L\'histoire se passe en 50 avant Jésus-Christ. Toute la Gaule est occupée par les Romains, sauf un village d\'Armorique... C\'est le village d\'Astérix et Obélix. Leur druide, Panoramix, fabrique une potion magique qui les rend invincibles.', 'Comédie', 1, '2014-09-03', 3, 2, 6, 42, NULL, 1),
(5, 'Le cercle des poètes disparus', 'Todd Anderson, un garçon plutôt timide, est envoyé dans la prestigieuse académie de Welton, réputée pour être l\'une des plus fermées et austères des États-Unis, là où son frère avait connu de brillantes études. C\'est dans cette université qu\'il va faire la rencontre d\'un professeur de lettres anglaises plutôt étrange, Mr Keating, qui les encourage à toujours refuser l\'ordre établi. Les cours de Mr Keating vont bouleverser la vie de l\'étudiant réservé et de ses amis', 'Drame', 1, '1989-10-06', 3, 5, 12, 64, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `reading` (
  ...
  PRIMARY KEY (`id_user`,`id_cover`,`id_choice`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
