                    ...
                    <div class="card text-center" style="width: 50rem;">
                        <div class="card-body">
                            ...
                            <a type="submit" class="btn btn-success"
                               href="index.php?action=creer-choix&idCover=<?= $cover['id_cover'] ?>&idChapter=<?= $chapter['id_chapter'] ?>">Ajouter
                                un
                                choix</a>
                            ...
                            <div class="card" href="book_page.php">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <form name="delete_cover" method="POST">
                                        <a href="index.php?action=supprimer-choix&idcov=<?= $choice['id_cover'] ?>&idchap=<?= $choice['id_current_chapter'] ?>&idchoice=<?= $choice['id_choice'] ?>"
