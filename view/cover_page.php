...
<?php } else { ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <button type="button" class="btn btn-danger btn-block mt-2" data-toggle="modal"
                                data-target="#modalDelete<?= $chapter['id_cover'] ?>">
                            Supprimer
                        </button>
                        <div class="modal fade" id="modalDelete<?= $chapter['id_cover'] ?>" tabindex="-1"
                             role="dialog"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="exampleModalLongTitle">Supprimer un
                                            chapitre</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form name="delete_cover" method="POST">
                                            <a href="index.php?action=supprimer-chapitre&idcov=<?= $chapter['id_cover'] ?>&idchap=<?= $chapter['id_chapter'] ?>"
    ...
    <div class="text-center">
        <button type="button" class="btn btn-primary px-3 py-2" data-toggle="modal"
                data-target="#modal<?= $cover['id_cover'] ?>">
            Je valide mon histoire
        </button>
        <div class="modal fade" id="modal<?= $cover['id_cover'] ?>" tabindex="-1"
             role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle">Valider son
                            histoire</h5>
                        <button type="button" class="close" data-dismiss="modal"
                                aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="index.php?action=valider-configuration-histoire&id=<?= $cover['id_cover'] ?>&idc=1"
                           class="btn btn-primary px-2 mt-auto">Valider
                            l'histoire</a>
                    </div>
                </div>
            </div>
