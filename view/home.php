                        ...
                        <div class="d-flex align-items-end flex-column card-body">
                            <?php if (!isset($_SESSION['id']) || (!userBookReading($_SESSION['id'], $book['id_cover']))) {
                                ...
                                <?php } else if (userBookFinished($book['id_cover'])) {
                                    ?>
                                    <a href="index.php?action=recommencer-histoire&id=<?= $book['id_cover'] ?>"
                                       class="btn btn-dark px-2 mt-auto">Relire
                                        l'histoire</a>
                                <?php } else { ?>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="exampleModalLongTitle">Commencer une histoire</h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="index.php?action=lire-histoire&idb=<?= $book['id_cover'] ?>&idc=1"
                                ...
                                <a href="index.php?action=lire-histoire&idb=<?= $book['id_cover'] ?>&idc=<?= getReadingProgress($_SESSION['id'], $book['id_cover']) ?>"
            ...
            <div class="row justify-content-around px-5">
                <div class="col-lg-4 col-md-4 col-sm-12 py-2">
                    <img class="rounded-circle z-depth-2" alt="library" width="250px" height="250px"
                         src="public/images/book_home.jpg" data-holder-rendered="true">
                </div>
                        ...
                        <div class="d-flex align-items-end flex-column card-body">
                            <?php if (!isset($_SESSION['id']) || (!userBookReading($_SESSION['id'], $b['id_cover']))) {
                                ...
                                <?php } else if (userBookFinished($b['id_cover'])) {
                                    ?>
                                    <a href="index.php?action=recommencer-histoire&id=<?= $b['id_cover'] ?>"
                                       class="btn btn-dark px-2 mt-auto">Relire
                                        l'histoire</a>
                                <?php } else { ?>
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                ...
                                <a href="index.php?action=lire-histoire&idb=<?= $b['id_cover'] ?>&idc=<?= getReadingProgress($_SESSION['id'], $book['id_cover']) ?>"
                                   class="btn btn-info px-2 mt-auto">Continuer
                                    l'histoire</a>
                            <?php } ?>
                        </div>
