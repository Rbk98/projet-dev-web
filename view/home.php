        ...
        <div class="container">
            <div class="row justify-content-around px-5">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    ...
                    <p class="text-muted">Bla-bla-bla explication de ce que le site fait, des différentes
                        possibilités
                            ...
                            <?php if (!isset($_SESSION['id']) || (!userBookReading($_SESSION['id'], $b['id_cover']))) {
                                if (!isset($_SESSION['id'])) { ?>
                                    <a href="index.php?action=connexion" class="btn btn-primary px-2 mt-auto">Commencer
                                        l'histoire</a>
                                <?php } else { ?>
                                    <a href="index.php?action=lire-histoire&idb=<?= $b['id_cover'] ?>&idc=1"
                                       class="btn btn-primary px-2 mt-auto">Commencer
                                        l'histoire</a>
                                <?php }
                            } else { ?>
                                <a href="index.php?action=lire-histoire&idb=<?= $b['id_cover'] ?>&idc=<?= getReadingProgress($book['id_cover']) ?>"
                                   class="btn btn-info px-2 mt-auto">Continuer
                                    l'histoire</a>
                            <?php } ?>
                        </div>
