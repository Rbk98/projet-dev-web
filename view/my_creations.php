...
<?php ob_start(); ?>
    ...
    <div class="bg-crea container m-3">
        ...
        <div class="col-2">
            <div class="card h-75">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=lire-histoire" class="btn btn-primary px-2">Continuer
                        l'édition</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="index.php?action=lire-histoire&id=1" class="btn btn-success px-2">
            ...
            <div class="col-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge bg-info text-dark">Aventure</span>
                        <p class="card-text">Petit résumé concernant la première histoire...</p>
                        <a href="index.php?action=lire-histoire&id=1" class="btn btn-secondary px-2">
