                                    ...
                                    if ($book['status'] == 2) { ?>
                                        <div class="row ">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="index.php?action=cacher-histoire&id=<?= $book['id_cover'] ?>" class="btn btn-primary px-2 mt-auto">
                                            ...
                                            <div class="col-12 col-lg-6  px-2 ">
                                                <a href="index.php?action=stat-histoire&id=<?= $book['id_cover'] ?>" class="btn btn-light btn-block ">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="index.php?action=publier-histoire&id=<?= $book['id_cover'] ?>" class="btn btn-primary px-2 mt-auto">
