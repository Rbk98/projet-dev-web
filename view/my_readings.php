                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="d-grid gap-2">
                                        <a href="index.php?action=lire-histoire&idb=<?= $reading['id_cover'] ?>&idc=<?= getReadingProgress($_SESSION['id'], $reading['id_cover']) ?>"
                                           class="btn btn-block btn-info px-2 mt-auto mb-2">Continuer
                                            la lecture</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-6 col-lg-3 mb-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <span class="badge badge-pill badge_style mb-3"><?= $cover['genre'] ?></span>
                            <p class="card-text  text-truncate--3"><?= $cover['summary'] ?></p>
                            <a href="index.php?action=lire-histoire&idb=<?= $reading['id_cover'] ?>&idc=1"
                               class="btn btn-primary px-2">Relire l'histoire</a>
                        </div>
                    </div>
                </div>
            <?php }
