                            ...
                            <div class="card h-100">
                                ...
                                <div class="d-flex align-items-end flex-column card-body">
                                    <?php if (!isset($_SESSION['id']) || (!userBookReading($_SESSION['id'], $book['id_cover']))) {
                                        ...
                                        ?>
                                            <a href="index.php?action=lire-histoire&idCover=<?= $book['id_cover'] ?>&idChapter=1&idChoice=0" class="btn btn-primary px-2 mt-auto">Relire
                                                l'histoire</a>
                                        <?php } else { ?>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Commencer une
                                                                histoire</h5>
