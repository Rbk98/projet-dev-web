                    ...
                    <fieldset class="form bg-light p-4 background ">
                        ...
                        <div class="row mb-2">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" placeholder="Titre du chapitre" name="title_chap" value="<?= $chapter['title'] ?>" id="title_chap"
                                       class="form-control">
                            </div>
                            <div class="col-12 mb-3">
                                <label for="content" class="col-form-label">Contenu</label>
                                <textarea class="form-control" placeholder="Contenu du chapitre"  name='content' id="content"
                                          style="height: 100px"><?= $chapter['content'] ?></textarea>
                            </div>
