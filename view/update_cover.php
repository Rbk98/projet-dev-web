                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                                ...
                                <input type="number" placeholder="Nombre de vies" name="nb_lives" id="nb_lives"
                                       class="form-control" value="<?= $cover['nb_lives'] ?>" required>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                                ...
                                <input type="number" placeholder="Nombre de chapitres max" name="nb_chapters_max"
                                       id="nb_chapters_max"
                                       class="form-control" value="<?= $cover['nb_chapters_max'] ?>" required>
                            </div>
                            <div class="col-12 mb-3">
